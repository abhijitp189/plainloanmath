    ...
    <main>
      ...
      <Prose>
        ...
        <Block title="Found an error?">
          <p>
            Please tell us, and please be specific &mdash; the page, the figure
        ...
        <Block title="What we cannot help with">
          ...
          <p>
            ...
            numbers, or copies of loan documents &mdash; we have no use for
        ...
        <Block title="Press, educators, and linking">
          <p>
            ...
            they are for &mdash; tell us and we will help.
          </p>
        </Block>
